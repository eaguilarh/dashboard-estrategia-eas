...
export const Module1Prioritization: React.FC<Module1Props> = ({ kpis, initiatives, theme = 'dark', onDrillDown, isCockpit = false }) => {
  ...
  return (
    <div className="space-y-4 text-left w-full select-none max-w-full overflow-hidden">
      ...
      {/* Main Widgets Row: Renders only Matriz in Cockpit view, otherwise renders all three side-by-side */}
      {isCockpit ? (
        /* Render ONLY Matriz inside Cockpit View */
        ...
        /* Render Full Dashboard View in Dedicated Module Tab */
